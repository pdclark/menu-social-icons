...
class Storm_Menu_Social_Icons {
	...
	var $networks = array(
		...
		'dribbble.com'       => array( 'class' => 'dribbble',      'icon' => 'icon-dribbble',      'icon-sign' => 'icon-dribbble-sign'      ),
		'dropbox.com'        => array( 'class' => 'dropbox',       'icon' => 'icon-dropbox',       'icon-sign' => 'icon-dropbox-sign'       ),
		'facebook.com'       => array( 'class' => 'facebook',      'icon' => 'icon-facebook',      'icon-sign' => 'icon-facebook-sign'      ),
		'flickr.com'         => array( 'class' => 'flickr',        'icon' => 'icon-flickr',        'icon-sign' => 'icon-flickr-sign'        ),
		'foursquare.com'     => array( 'class' => 'foursquare',    'icon' => 'icon-foursquare',    'icon-sign' => 'icon-foursquare-sign'    ),
		...
		'instagr.am'         => array( 'class' => 'instagram',     'icon' => 'icon-instagram',     'icon-sign' => 'icon-instagram-sign'     ),
		'instagram.com'      => array( 'class' => 'instagram',     'icon' => 'icon-instagram',     'icon-sign' => 'icon-instagram-sign'     ),
		...
		'renren.com'         => array( 'class' => 'renren',        'icon' => 'icon-renren',        'icon-sign' => 'icon-renren-sign'        ),
		'stackoverflow.com'  => array( 'class' => 'stackoverflow', 'icon' => 'icon-stackoverflow', 'icon-sign' => 'icon-stackoverflow-sign' ),
		'trello.com'         => array( 'class' => 'trello',        'icon' => 'icon-trello',        'icon-sign' => 'icon-trello-sign'        ),
		'tumblr.com'         => array( 'class' => 'tumblr',        'icon' => 'icon-tumblr',        'icon-sign' => 'icon-tumblr-sign'        ),
		'twitter.com'        => array( 'class' => 'twitter',       'icon' => 'icon-twitter',       'icon-sign' => 'icon-twitter-sign'       ),
		'vk.com'             => array( 'class' => 'vk',            'icon' => 'icon-vk',            'icon-sign' => 'icon-vk-sign'            ),
		'weibo.com'          => array( 'class' => 'weibo',         'icon' => 'icon-weibo',         'icon-sign' => 'icon-weibo-sign'         ),
		'xing.com'           => array( 'class' => 'xing',          'icon' => 'icon-xing',          'icon-sign' => 'icon-xing-sign'          ),
